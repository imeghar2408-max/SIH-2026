  ...
  const activities = [
    {
      ...
      level: "EASY",
      time: "5 MIN",
      desc: "Match pairs of cards to exercise your short-term memory.",
      view: "patient-game",
    },
    {
      ...
      level: "MEDIUM",
      time: "10 MIN",
      desc: "Find the small changes between two similar pictures.",
    ...
    },
    {
      ...
      level: "EASY",
      time: "5 MIN",
      desc: "Complete simple sequences of shapes and colors.",
      view: "patient-activities",
    },
    {
      title: "Daily Routine",
      level: "EASY",
      time: "8 MIN",
      desc: "Organize daily tasks into the correct order.",
      view: "patient-activities",
    },
  ];
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">
          Take your time to select an activity. These exercises help keep your
      ...
      <div className="grid grid-cols-4 gap-4">
        ...
        <div className="bg-white p-5 rounded-2xl border border-red-100 bg-red-50/20">
          <div className="flex justify-between items-center text-red-600 text-xs mb-2">
            ...
            <span className="bg-red-100 px-1.5 py-0.5 rounded font-bold">
              Action Req.
            </span>
          </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex space-x-6 text-xs font-semibold text-gray-500 border-b">
        ...
        <button className="pb-2 border-b-2 border-[#0f3e3a] text-[#0f3e3a]">
          Cognitive Progress
        </button>
        <button
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white p-6 rounded-3xl border border-gray-200">
            ...
            <div className="h-40 flex items-end space-x-2 pt-8">
              {[40, 45, 48, 55, 60, 62, 70, 75, 72, 85, 80, 88].map(
                (val, i) => (
        ...
        <div className="bg-teal-50/50 p-6 rounded-3xl border border-teal-100 space-y-4">
          ...
          <div className="bg-white p-4 rounded-2xl border border-teal-50 text-xs text-gray-700 leading-relaxed">
            Memory performance has improved over the last 2 weeks during visual
            recall games.
          </div>
          <div className="bg-white p-4 rounded-2xl border border-teal-50 text-xs text-gray-700 leading-relaxed">
